...
public class RolesController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(200, Type = typeof(NaitrustResponse<List<RoleResponse>>))]
    ...
    /// <summary>Get roles assigned to a user by email</summary>
    [HttpGet("user/{email}")]
    [ProducesResponseType(200, Type = typeof(NaitrustResponse<List<string>>))]
    [ProducesResponseType(401, Type = typeof(NaitrustResponse))]
    ...
    [HttpPost]
    [ProducesResponseType(201, Type = typeof(NaitrustResponse<RoleResponse>))]
    ...
    [HttpPut("{roleId:guid}")]
    [ProducesResponseType(200, Type = typeof(NaitrustResponse<RoleResponse>))]
    [ProducesResponseType(400, Type = typeof(NaitrustResponse))]
    [ProducesResponseType(401, Type = typeof(NaitrustResponse))]
    [ProducesResponseType(404, Type = typeof(NaitrustResponse))]
