...
namespace Naitrust.Infrastructure.Migrations
{
    ...
    [Migration("20260815030346_DealDeliveryState_DealIdentityCapture")]
    partial class DealDeliveryState_DealIdentityCapture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.Business", b =>
                {
                    ...
                    b.Property<string>("PaymentAccountBankName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.Deal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int?>("ActivePaymentStage")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DeliveryDueDate")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<int?>("ExtendedProductTestingDays")
                        .HasColumnType("integer");

                    b.Property<long>("FeeMinor")
                        .HasColumnType("bigint");

                    b.Property<DateTime?>("FirstPaymentReleasedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<long?>("InitialPaymentMinor")
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("NextPaymentReleaseConditions")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<long?>("RemainingPaymentMinor")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.DealInvitation", b =>
                {
                    ...
                    b.Property<string>("IntendedAccountType")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("IntendedContact")
                        .HasMaxLength(320)
                        .HasColumnType("character varying(320)");
                    ...
                    b.Property<string>("PostAuthDestination")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.ToTable("DealInvitations", (string)null);
                });

            modelBuilder.Entity("Naitrust.Domain.Models.Entities.DealMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.DealParty", b =>
                {
                    ...
                    b.Property<long?>("AllocationMinor")
                        .HasColumnType("bigint");

                    b.Property<long?>("AllocationStage1Minor")
                        .HasColumnType("bigint");

                    b.Property<long?>("AllocationStage2Minor")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.DealTermination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.LinkedBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.NaitrustUser", b =>
                {
                    ...
                    b.Property<string>("AnchorCustomerId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.Negotiation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("LatestProposalId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.UserCounterpartyPreference", b =>
                {
                    ...
                    b.ToTable("UserCounterpartyPreferences");
                });
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.WaitlistEntry", b =>
                {
                    ...
                    b.Property<string>("TransactionNeed")
                        .HasColumnType("text");

                    b.Property<string>("TransactionRange")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Naitrust.Domain.Models.Entities.WalletActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
