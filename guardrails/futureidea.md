...
> Providus Bank is the development adapter for virtual accounts/collection accounts, funding confirmation, transfers, and webhooks.

Future adapters can include Kora/Korapay, Wema Bank, Anchor, and other licensed partners behind the same payment adapter interface.
...
- "compliance"
- "escrow"
- "regulated transaction infrastructure"
...
6. Issue a partner-provided virtual account or collection account through Providus Bank during development.
...
Turn completed safe transactions into portable trust.
...
Naitrust should avoid holding customer funds directly unless properly licensed.
...
- Marketing language.
- Whether Providus Bank explicitly permits protected-transaction flows.
- Whether future partners such as Kora/Korapay, Wema Bank, and Anchor permit the same flow.
